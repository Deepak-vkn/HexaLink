   ...
   const handleLogout = async () => {
      try {
        ...
        if (result.success) {
          ...
          navigate('/compan'); // Ensure this path matches your route configuration
        }
      } catch (error) {
...
<header className="bg-white dark:bg-gray-800 shadow-md p-4">
          <div className="container mx-auto flex justify-between items-center">
            ...
            <h1 className="text-2xl font-semibold text-gray-900 dark:text-white">Company Dashboard</h1>
            
            {/* Sign-in Name Button with Dropdown */}
            <div className="relative flex items-center gap-x-1">
              ...
              {/* Dropdown menu */}
              {isDropdownOpen && (
                <div className="z-10 absolute right-0 mt-2 w-30 bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600">
