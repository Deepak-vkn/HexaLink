...
const CompanyNav: React.FC<CompanyNavProps> = ({ user }) => {
  ...
  const handleLogout = async () => {
    try {
      ...
      if (result.success) {
        ...
        navigate('/company'); // Ensure this path matches your route configuration
      }
    } catch (error) {
  ...
  return (
    <>
      ...
      >
        ...
        <div className="p-4 text-lg font-semibold text-gray-900 dark:text-white border-b dark:border-gray-700">
            Company Dashboard
          </div>
          <ul className="space-y-2 font-medium">
            ...
            <li>
              ...
              >
                <svg
                  ...
                  viewBox="0 0 18 18"
                >
                  <path d="M16.143 2.143H1.857A1.857 1.857 0 0 0 0 4v10a1.857 1.857 0 0 0 1.857 1.857h14.286A1.857 1.857 0 0 0 18 14V4a1.857 1.857 0 0 0-1.857-1.857ZM8.25 13.5a.75.75 0 0 1-.75-.75v-5a.75.75 0 0 1 .75-.75.75.75 0 0 1 .75.75v5a.75.75 0 0 1-.75.75Zm3.75 0a.75.75 0 0 1-.75-.75v-5a.75.75 0 0 1 .75-.75.75.75 0 0 1 .75.75v5a.75.75 0 0 1-.75.75Zm3.75 0a.75.75 0 0 1-.75-.75v-5a.75.75 0 0 1 .75-.75.75.75 0 0 1 .75.75v5a.75.75 0 0 1-.75.75Z" />
                </svg>
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Shortlisted</span>
              </a>
            </li>
            <li>
              <a
